...
from preprocessing import load_wine_data, split_data, scale_data, save_data
...
class WineClassifierFlow(FlowSpec):
    ...
    data_path = Parameter('data_path', default='https://storage.googleapis.com/lab7-bucket-yna/wine.data', type=str)
    ...
    def join_models(self, inputs):
        ...
        mlflow.set_experiment("wine-classifier-experiment")
